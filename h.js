...
function proceedToOrder() {
  ...
  const fullOrder = {
    soup: selectedSoup ? { name: selectedSoup.name, price: selectedSoup.price, keyword: selectedSoup.keyword } : null,
    main: selectedMain ? { name: selectedMain.name, price: selectedMain.price, keyword: selectedMain.keyword } : null,
    drink: selectedDrink ? { name: selectedDrink.name, price: selectedDrink.price, keyword: selectedDrink.keyword } : null,
    salad: selectedSalad ? { name: selectedSalad.name, price: selectedSalad.price, keyword: selectedSalad.keyword } : null,
    dessert: selectedDessert ? { name: selectedDessert.name, price: selectedDessert.price, keyword: selectedDessert.keyword } : null,
